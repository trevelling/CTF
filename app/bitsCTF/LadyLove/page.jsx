  ...
  return (
    <div className={styles.ladyLoveContainer}>
      ...
      <div className={styles.ladyLoveSolved}>
        <p>
        They gave us a picture of a painting. Immediately, I did a reverse image search on the painting to find more information on it. Going through the first website, it seems that the painter's name is Peter Adolf Hall.
        </p>
      </div>
      ...
      <div className={styles.ladyLoveSolved}>
        <p>
        Reading his history on Wikipedia, it seems that he was born in Sweden but died in Belgium, suggesting that his LadyLove was also from Belgium.
        Due to low solves and after some time, the authors provided us a hint which was the birthdate of LadyLove.
        </p>
      </div>
      <div className={styles.ladyLoveEvidence}>
      ...
      <div className={styles.ladyLoveSolved}>
        <p>
        Googling for Belgium ladies born on 1918, I founded a specific woman named Keriman Halis Ece. Reading her Wikipedia, the meaning of her last name can be found where <strong>Ece means queen.</strong>
        </p>
      </div>
      <div className={styles.ladyLoveEvidence}>
