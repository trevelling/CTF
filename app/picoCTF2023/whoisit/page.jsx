...
export default function WhoIsIt() {
  return (
    <div className={styles.whoIsItContainer}>
      <div className={styles.whoIsItTitle} style={{ color: "white"}}>
          who is it
        <br />
      </div>
      <div className={styles.whoIsItQuestion}>
        ...
        <p>
          ...
          <a
            ...
            href="/pico2023/email-export.eml"
            download
          >
            email-export.eml
          </a>
      ...
      <div className={styles.whoIsItSolved}>
        <p>
          Opening <code>email-export.eml</code>, will gives us what looks to be a scam email. To get the flag we need to find who sent this email.
          <br />
          <br />
...
----_NmP-426c22a2e0d8fc9a-Part_1--
  ...
  `}
      ...
      <div className={styles.whoIsItSolved}>
        <p>
         We are able to find the <code>First</code> and <code>Last</code> name of the sender by finding a <code>IP address</code> in the email.
        </p>
      </div>
      <div className={styles.whoIsItEvidence}>
...
IP Address of Sender: 173.249.33.206
  `}
      ...
      <div className={styles.whoIsItSolved}>
        <p>
          We can use the <code>whois</code> command to find more information about this IP address. Scrolling down will result in the name of the sender, which is our flag.
        </p>
      </div>
      <div className={styles.whoIsItEvidence}>
        <SyntaxHighlighter language="bash" style={gruvboxDark}>
...
% This query was served by the RIPE Database Query Service version 1.109.1 (SHETLAND)
      ...
      <div className={styles.whoIsItFlag}>
        <span>Flag: </span>
